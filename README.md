...
## ¿Como utilizarlo?
1. Clone o descargue el proyecto [aqui](https://github.com/IsaacCuautle/generador-de-frases-de-series-aleatorias/releases/download/v1.0.0/generador-de-frases-de-series-aleatorias-main.zip)
